...
\begin{enumerate}
  ...
  \begin{equation}
      QPT = t_{\text{query completed}} - t_{\text{query initiated}}
  \end{equation}
  ...
  \begin{equation}
      SRL = t_{\text{secret retrieved}} - t_{\text{retrieval initiated}}
  \end{equation}
  ...
  \begin{equation}
      DIV = \text{Hash(Data Sent)} \stackrel{?}{=} \text{Hash(Data Received)}
  \end{equation}
