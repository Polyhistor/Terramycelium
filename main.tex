...
\begin{table*}[h]
  ...
  \hline
  Velocity & Vel-4 & System needs to be able to ingest multiple, continuous, time-varying data streams. \\
  \hline
  Velocity & Vel-5 & System shall support fast search from streaming and processed data with high accuracy and relevancy. \\
  \hline
  Velocity & Vel-6 & System should be able to process data in a real-time or near real-time manner. \\
  \hline
  ...
  \hline
  Variety & Var-3 & System needs to support aggregation, standardization, and normalization of data from disparate sources. \\
  \hline
  Variety & Var-4 & System shall support adaptation mechanisms for schema evolution. \\
  \hline
  Variety & Var-5 & System can provide mechanisms to automatically include new data sources. \\
  \hline
