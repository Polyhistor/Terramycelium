...
The research methodology for soliciting expert feedback comprised five stages: \begin{enumerate}[label=\alph*)]
  ...
  The semi-structured protocol for expert opinion is inspired by the works of Kallio et al. \cite{kallio2016systematic}. This protocol is aimed to extract expert opinion while ensuring participant-centricity. Close-ended questions facilitated quantifiable data extraction and conversation initiation.
  ...
  Purposive sampling identified experts, providing in-depth insights through targeted selection \cite{baltes2022sampling}. Contacts were initiated with professionals in relevant roles, such as data engineers, data architects, chief data and analytics offers, solution engineers, solution architacts, principal data engineers, staff data engineers, principal architectures and scholars and researchers whose work is in BD systems. Over two months, three experts across different sectors were selected as displayed Table~\ref{tab:experts}.
  ...
  The guide underwent internal peer review and an empirical pilot study with another reseachers to diagnose incongruities, refine ancillary questions, and calibrate the discourse trajectory. This iterative refinement accentuated the study's rigor.
...
The architecture's adaptable characteristics and all-encompassing ecosystem also garnered favourable recognition. i3 mentioned that the architecture seems to be effective for its capacity to handle wide range of tasks, including batch eventing and stream processing. I3 also emphasised the importance of maintaining immutable logs, which ensures a reliable and authoritative source of information. This expert highlighted the important of data dimensions such as bitemporality and immutability. 
...
Moreover, the architecture's ability to promote the idea of platform as a service was considered essential.
